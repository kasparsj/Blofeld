...
Pdef(\rhythms,
	Pwrand([
		...
		Pbind(
			...
			\ampEnvDecay, 127,
			\ampEnvRelease, Pseq([0,Pexprand(2,7,48)],1),
		...
		Pbind(
			...
			\ampEnvSustain, 0,
			\ampEnvDecay, 127,
			\ampEnvRelease, Pstutter(6, Pexprand(0,2)),
			\effect2Mix, Pwhite(0,20),
			\lfo1Shape, Blofeld.lfoShape[\random],
			\lfo1Speed, 1,
			\osc1FMSource, Blofeld.fmSource[\lfo1],
